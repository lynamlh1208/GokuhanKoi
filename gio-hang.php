...
{
	echo "<script>alert('Bạn không có sản phẩm trong giỏ hàng ');location.href='index.php'</script>";
}
?>
		...
		<table class="table table-hover" id="shoppingcart-info">
			...
			<tbody> 
				...
				<tr>
					...
					<td>
						<a href="#" class="btn btn-xs btn-info updatecart" data-key=<?php echo $key ?>><i class="fa fa-refresh"></i> Cập nhập</a>
